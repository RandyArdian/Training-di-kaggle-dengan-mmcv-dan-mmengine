...
#Train YOLO11n
!yolo train model="YOLO/yolo11n_Disertasi1.yaml" data=VisDrone.yaml epochs=100 imgsz=640 resume=True batch=8 optimizer=SGD momentum=0.937 warmup_momentum=0.8 
